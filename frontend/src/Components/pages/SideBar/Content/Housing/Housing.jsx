...
const Housing = () => {
    ...
    const calculateTotalMonthlyHousing = () => {
    ...
    const calculateTotalAnnualyHousing = () => {
        return incomeData.reduce((total, income) => {
            const amount = parseFloat(income.amount);
            switch (income.frequency) {
                case 'weekly':
    ...
    const totalMonthly = calculateTotalMonthlyHousing();
                        ...
                        <tfoot className="customTableFooter">
                            <tr>
                                ...
                                <td className="totalAmount" colSpan="1">
                                    TND {calculateTotalMonthlyHousing().toFixed(2)}
                                </td>
                            </tr>
                            <tr>
                                <td className="totalMonthly" colSpan="1">Total Housing Annually</td>
                                <td className="totalAmount" colSpan="1">
                                    TND {calculateTotalAnnualyHousing().toFixed(2)}
                                </td>
                            </tr>
                        </tfoot>
